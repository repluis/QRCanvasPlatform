        ...
        <div class="space-y-3">
            <div v-if="element.type === 'text'">
                ...
                <input
                    ...
                    class="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 outline-none transition focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400"
            ...
            <div v-if="element.type === 'text'">
                ...
                <div class="flex gap-1.5">
                    <button
                        class="rounded-lg border px-3 py-1.5 text-sm text-gray-700 transition hover:bg-gray-100"
                    ...
                    <button
                        class="rounded-lg border px-3 py-1.5 text-sm italic text-gray-700 transition hover:bg-gray-100"
                    ...
                    <button
                        class="rounded-lg border px-3 py-1.5 text-sm underline text-gray-700 transition hover:bg-gray-100"
